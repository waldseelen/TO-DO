      ...
      <div className="bg-white dark:bg-dark-surface w-full max-w-lg rounded-2xl shadow-2xl border border-slate-100 dark:border-slate-700 flex flex-col max-h-[90vh]">
        <div className="p-4 border-b border-slate-100 dark:border-slate-700 flex justify-between items-center bg-slate-50/50 dark:bg-slate-800/50 rounded-t-2xl">
          ...
          <div className="flex gap-2">
            <button onClick={searchGoogle} className="p-1.5 bg-blue-100 text-blue-600 rounded-lg hover:bg-blue-200" title="Google'da Ara">
              <Globe size={18} />
            </button>
            <button onClick={searchYoutube} className="p-1.5 bg-red-100 text-red-600 rounded-lg hover:bg-red-200" title="Youtube'da Ara">
              <Youtube size={18} />
            </button>
              ...
              <div className="flex bg-slate-100 dark:bg-slate-800 rounded-lg p-0.5">
                <button
                  ...
                  className={`px-2 py-1 text-xs rounded-md transition-all ${
                    activeTab === 'write' ? 'bg-white dark:bg-slate-600 shadow text-indigo-600 dark:text-indigo-300' : 'text-slate-500'
                  }`}
                >
                  Yaz
                </button>
                <button
                  ...
                  className={`px-2 py-1 text-xs rounded-md transition-all ${
                    activeTab === 'preview' ? 'bg-white dark:bg-slate-600 shadow text-indigo-600 dark:text-indigo-300' : 'text-slate-500'
                  }`}
                >
                  Önizle
                </button>
                ...
                <div key={sub.id} className="flex items-center gap-2 group">
                  <button
                    ...
                    className={`w-4 h-4 rounded border flex items-center justify-center ${
                      sub.completed ? 'bg-green-500 border-green-500 text-white' : 'border-slate-300 dark:border-slate-600'
                    }`}
                  >
