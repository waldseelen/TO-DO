            ...
            <div className="bg-white dark:bg-dark-surface p-6 rounded-2xl shadow-xl max-w-md w-full border border-slate-100 dark:border-slate-700 max-h-[90vh] overflow-y-auto custom-scrollbar">
                ...
                <div className="space-y-4">
                    ...
                    <div className="p-4 bg-amber-50 dark:bg-amber-900/20 rounded-xl border border-amber-100 dark:border-amber-900/50">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    <h4 className="font-bold text-amber-700 dark:text-amber-400">Completion Sound</h4>
                                    <p className="text-xs text-amber-600/70 dark:text-amber-400/70">Play sound when task is completed</p>
                                </div>
                            </div>
                            <button
                    ...
                    <div className="p-4 bg-indigo-50 dark:bg-indigo-900/20 rounded-xl border border-indigo-100 dark:border-indigo-900/50">
                        <h4 className="font-bold text-indigo-700 dark:text-indigo-400 mb-1">Backup Data</h4>
                        <p className="text-xs text-indigo-600/70 dark:text-indigo-400/70 mb-3">Download all your progress as a JSON file.</p>
                        <button
                            onClick={onExport}
                    ...
                    <div className="p-4 bg-emerald-50 dark:bg-emerald-900/20 rounded-xl border border-emerald-100 dark:border-emerald-900/50">
                        ...
                        <p className="text-xs text-emerald-600/70 dark:text-emerald-400/70 mb-3">Copy today's completed tasks for Obsidian/Notion.</p>
                        <button
                    ...
                    <div className="p-4 bg-slate-50 dark:bg-slate-800 rounded-xl border border-slate-100 dark:border-slate-700">
                        <h4 className="font-bold text-slate-700 dark:text-slate-300 mb-1">Load Backup</h4>
                        <p className="text-xs text-slate-500 mb-3">Restore a previously downloaded backup.</p>
